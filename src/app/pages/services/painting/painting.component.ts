...
export class PaintingComponent implements OnInit {
  ...
  menu = {
    ...
    ccca: {
      title: 'Which specific exterior parts need painting?',
      options: [
        {
          choice: 'Roof',
          next: 'dddv1',
    ...
    cccb: {
      title: 'Which specific interior parts need painting?',
      options: [
        {
          choice: 'Ceiling',
          next: 'dddv3',
    ...
    ddda: {
      title: 'What type of the paint you want?',
      options: [
        {
          choice: 'Water Paint',
          next: 'eeev1',
