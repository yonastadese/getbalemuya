  ...
  menu = {
    ...
    aaad: {
      ...
      options: [
        ...
        {
          choice: 'Install security camera',
          next: 'zaab'
        },
        {
          choice: 'Mount security fence',
          next: 'zaac'
        },
        {
          choice: 'Others',
    ...
    zaab: {
      value: 'Install security camera',
      title: 'Where do you want the security camera installed?',
      options: [
        {
          choice: 'Outside the compound',
          next: 'bbbv1'
        },
        {
          choice: 'By the gate',
    ...
    bbbv5: {
      value: 'I need your advice',
      skipTo: 'basicInfo'
    },
    zaac: {
      value: 'Mount security fence',
      title: 'What kind of security fence?',
      options: [
        {
          choice: 'Electric fence',
          next: 'bbbv6'
        },
        {
          choice: 'Pointed wire',
